...
extern float yaw,yaw_base;
float yawdilta_cal_sv=0;
...
float Servo_turn_where_target_is(void)
{
	...
	yaw_base_cal=yaw_base<0?yaw_base+360:yaw_base;
	yawdilta_cal = yaw_base_cal-yaw_cal;
	yawdilta_cal=yawdilta_cal>0?yawdilta_cal:yawdilta_cal+360;//对于负值来说，其位置是加上360度的部分
	yawdilta_cal=yawdilta_cal<270?yawdilta_cal:270;//限制270度
